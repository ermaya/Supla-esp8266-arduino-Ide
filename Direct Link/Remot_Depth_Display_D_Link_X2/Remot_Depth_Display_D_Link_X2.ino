...
int Temp_mtbs = 30000;                // update interval 30 seconds
...
void ondemandwifiCallback () {
  ...
  WiFiManagerParameter custom_D_Link_1("Link 1", "Direct Link1", D_Link_1, 40);
  ...
  wifiManager.setMinimumSignalQuality();
    ...
    if (!wifiManager.startConfigPortal("Remote_depth")) {
