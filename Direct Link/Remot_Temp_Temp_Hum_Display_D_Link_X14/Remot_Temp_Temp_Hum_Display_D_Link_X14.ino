...
void ondemandwifiCallback () {
  ...
  WiFiManagerParameter custom_Link_T("Link T", "Direct Link T", Link_T, 40);
  WiFiManagerParameter custom_Link_T_H("Link T H", "Direct Link T+H", Link_T_H, 40);
  ...
  wifiManager.setMinimumSignalQuality();
    ...
    if (!wifiManager.startConfigPortal("DLink14")) {
...
void setup() {  //------------------------------------------------ Setup ----------------------------------------------
  ...
  lcd.print("Supla Remote Display"); 
  lcd.setCursor(0, 1);
  //       (x12345678901234567890x)
