...
char D_Link_2[40] = "/direct/XX/XXXXXXXXXXXXXXX/turn-on";
char D_Link_3[40] = "/direct/XX/XXXXXXXXXXXXXXX/turn-on";
char D_Link_4[40] = "/direct/XX/XXXXXXXXXXXXXXX/turn-on";
char D_Link_5[40] = "/direct/XX/XXXXXXXXXXXXXXX/turn-on";
char D_Link_6[40] = "/direct/XX/XXXXXXXXXXXXXXX/turn-on";
char D_Link_7[40] = "/direct/XX/XXXXXXXXXXXXXXX/turn-on";
char D_Link_8[40] = "/direct/XX/XXXXXXXXXXXXXXX/turn-on";
byte mac[6];
String url = "/direct";
...
void ondemandwifiCallback () {
  ...
  WiFiManagerParameter custom_D_Link_7("Link 7", "Direct Link 7", D_Link_8, 40);
  WiFiManagerParameter custom_D_Link_8("Link 8", "Direct Link 8", D_Link_7, 40);
  ...
  wifiManager.setMinimumSignalQuality(10);
    ...
    if (!wifiManager.startConfigPortal("DirectLink8")) {
