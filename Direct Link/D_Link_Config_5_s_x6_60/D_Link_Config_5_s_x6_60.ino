...
void ondemandwifiCallback () {
  ...
  WiFiManagerParameter custom_D_Link_2("Link 2", "D_Link_2", D_Link_2, 60);
  WiFiManagerParameter custom_D_Link_3("Link 3", "D_Link_3", D_Link_3, 60);
  WiFiManagerParameter custom_D_Link_4("Link 4", "D_Link_4", D_Link_4, 60);
  WiFiManagerParameter custom_D_Link_5("Link 5", "D_Link_5", D_Link_5, 60);
  WiFiManagerParameter custom_D_Link_6("Link 6", "D_Link_6", D_Link_6, 60);
  ...
  wifiManager.setMinimumSignalQuality(10);
    ...
    if (!wifiManager.startConfigPortal("DirectLink6")) {
