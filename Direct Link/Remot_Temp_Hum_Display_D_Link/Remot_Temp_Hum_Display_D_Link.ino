...
int Temp_mtbs = 30000;                //Temperature update delay
unsigned long Temp_lasttime; 
unsigned long wifi_checkDelay = 20000;  // wifi reconnect delay tray to reconnect every 20 seconds ---------new---------- Wi-Fi podłącz tacę opóźniającą, aby ponownie połączyć się co 20 sekund
...
// The extra parameters to be configured (can be either global or just in the setup)
  ...
  // set configportal timeout
    ...
    if (!wifiManager.startConfigPortal("Remote_Temp")) {
