...
#define Link_1_PIN  5     // triger Link 1  D1
#define Link_2_PIN  4     // triger Link 2  D2
#define Link_3_PIN 14     // triger Link 3 D5
#define Link_4_PIN 12     // triger Link 4 D6
#define TRIGGER_PIN 13    // wifi config D7
#define Ce_PIN 15         // CE output D8           
...
void setup() {  //------------------------------------------------ Setup ----------------------------------------------
  ...
  pinMode(Link_2_PIN, INPUT);
  pinMode(Link_3_PIN, INPUT);
  pinMode(Link_4_PIN, INPUT);
  ...
  else if ( digitalRead(Link_1_PIN) == HIGH)  {
    digitalWrite(Ce_PIN, HIGH);  
    state =1;       
  }
   else if ( digitalRead(Link_2_PIN) == HIGH)  {
    digitalWrite(Ce_PIN, HIGH); 
    state =2;       
  }
   else if ( digitalRead(Link_3_PIN) == HIGH )  {
    digitalWrite(Ce_PIN, HIGH); 
    state =3;       
  }
   else if ( digitalRead(Link_4_PIN) == HIGH)  {
    digitalWrite(Ce_PIN, HIGH); 
    state =4;       
  }
   else if ( digitalRead(TRIGGER_PIN) == HIGH)  {
    digitalWrite(Ce_PIN, HIGH); 
    state =5;      
  }
  else{
