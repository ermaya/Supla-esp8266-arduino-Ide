If you are interested in testing in a different way to use the StatusLed.
...
and blinks x times every 15 seconds according to the Supla cloud connection error.
