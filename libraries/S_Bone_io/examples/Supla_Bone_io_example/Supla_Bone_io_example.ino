...
void setup() {
  ...
  */
  ...
  relay_8->getChannel()->setDefault(SUPLA_CHANNELFNC_POWERSWITCH);
  relay_9->getChannel()->setDefault(SUPLA_CHANNELFNC_POWERSWITCH);
  relay_10->getChannel()->setDefault(SUPLA_CHANNELFNC_POWERSWITCH);
  relay_11->getChannel()->setDefault(SUPLA_CHANNELFNC_POWERSWITCH);
  relay_12->getChannel()->setDefault(SUPLA_CHANNELFNC_POWERSWITCH);
  relay_13->getChannel()->setDefault(SUPLA_CHANNELFNC_POWERSWITCH);
  relay_14->getChannel()->setDefault(SUPLA_CHANNELFNC_POWERSWITCH);
  relay_15->getChannel()->setDefault(SUPLA_CHANNELFNC_POWERSWITCH);
  relay_16->getChannel()->setDefault(SUPLA_CHANNELFNC_POWERSWITCH);

  relay_17->getChannel()->setDefault(SUPLA_CHANNELFNC_POWERSWITCH);
  relay_18->getChannel()->setDefault(SUPLA_CHANNELFNC_POWERSWITCH);
  relay_19->getChannel()->setDefault(SUPLA_CHANNELFNC_POWERSWITCH);
  relay_20->getChannel()->setDefault(SUPLA_CHANNELFNC_POWERSWITCH);
  relay_21->getChannel()->setDefault(SUPLA_CHANNELFNC_POWERSWITCH);
  relay_22->getChannel()->setDefault(SUPLA_CHANNELFNC_POWERSWITCH);
  relay_23->getChannel()->setDefault(SUPLA_CHANNELFNC_POWERSWITCH);
  relay_24->getChannel()->setDefault(SUPLA_CHANNELFNC_POWERSWITCH);
  relay_25->getChannel()->setDefault(SUPLA_CHANNELFNC_POWERSWITCH);
  relay_26->getChannel()->setDefault(SUPLA_CHANNELFNC_POWERSWITCH);
  relay_27->getChannel()->setDefault(SUPLA_CHANNELFNC_POWERSWITCH);
  relay_28->getChannel()->setDefault(SUPLA_CHANNELFNC_POWERSWITCH);
  relay_29->getChannel()->setDefault(SUPLA_CHANNELFNC_POWERSWITCH);
  relay_30->getChannel()->setDefault(SUPLA_CHANNELFNC_POWERSWITCH);
  relay_31->getChannel()->setDefault(SUPLA_CHANNELFNC_POWERSWITCH);
  relay_32->getChannel()->setDefault(SUPLA_CHANNELFNC_POWERSWITCH);
  ...
  */
  ...
  SuplaDevice.setName("Bone_io_test");
