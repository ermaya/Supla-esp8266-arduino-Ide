...
void setup() {    //    ------------------------ Setup --------------------------
  ...
  SuplaDevice.addDS18B20Thermometer();
  SuplaDevice.addDS18B20Thermometer();
    SuplaDevice.addRelay(relay1, false); 
    SuplaDevice.addRelay(relay2, false); 
    SuplaDevice.addRelay(relay3, false);
    SuplaDevice.addSensorNO(sensor1, true);
    SuplaDevice.addSensorNO(sensor2, true);   
