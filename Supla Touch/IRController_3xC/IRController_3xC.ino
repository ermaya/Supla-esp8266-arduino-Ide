...
void sendHomePage(String message, String header, int type, int httpcode) {
  ...
  if (last_recv.valid) {
    server->sendContent("              <form style='display:inline-block; margin:0; padding:0' action='/json' method='post'><tr class='text-uppercase'><td><code>" + String(last_recv.data) + "</code></td><td><code>" + String(last_recv.encoding) + "</code></td><td><code>" + String(last_recv.bits) + "</code></td><td> <a class='btn btn-warning btn-xs' href='/store?id=1' role='button'>Store</a></td></tr></form>\n");
  }  
  if (last_recv_2.valid) {
    server->sendContent("              <form style='display:inline-block; margin:0; padding:0' action='/json' method='post'><tr class='text-uppercase'><td><code>" + String(last_recv_2.data) + "</code></td><td><code>" + String(last_recv_2.encoding) + "</code></td><td><code>" + String(last_recv_2.bits) + "</code></td><td> <a class='btn btn-warning btn-xs' href='/store?id=2' role='button'>Store</a></td></tr></form>\n");
    }
    if (last_recv_3.valid) {
    server->sendContent("              <form style='display:inline-block; margin:0; padding:0' action='/json' method='post'><tr class='text-uppercase'><td><code>" + String(last_recv_3.data) + "</code></td><td><code>" + String(last_recv_3.encoding) + "</code></td><td><code>" + String(last_recv_3.bits) + "</code></td><td> <a class='btn btn-warning btn-xs' href='/store?id=3' role='button'>Store</a></td></tr></form>\n");
    }
    if (last_recv_4.valid) {
    server->sendContent("              <form style='display:inline-block; margin:0; padding:0' action='/json' method='post'><tr class='text-uppercase'><td><code>" + String(last_recv_4.data) + "</code></td><td><code>" + String(last_recv_4.encoding) + "</code></td><td><code>" + String(last_recv_4.bits) + "</code></td><td> <a class='btn btn-warning btn-xs' href='/store?id=4' role='button'>Store</a></td></tr></form>\n");
    }
    if (last_recv_5.valid) {
    server->sendContent("              <form style='display:inline-block; margin:0; padding:0' action='/json' method='post'><tr class='text-uppercase'><td><code>" + String(last_recv_5.data) + "</code></td><td><code>" + String(last_recv_5.encoding) + "</code></td><td><code>" + String(last_recv_5.bits) + "</code></td><td> <a class='btn btn-warning btn-xs' href='/store?id=5' role='button'>Store</a></td></tr></form>\n");
    }
  ...
  server->sendContent("            <tbody>\n");
  server->sendContent("           <tr class='text-uppercase'><td>Channel 1</td><td>" + State0 + "</td><td> " + (btn[0].ms / 1000.0) + " Seconds</td><td> <a class='btn btn-success btn-xs' href='/controlon?id=0?' role='button'>On</a> <a class='btn btn-danger btn-xs' href='/controloff?id=0' role='button'>Off</a></td></tr>\n");
  server->sendContent("           <tr class='text-uppercase'><td>Channel 2</td><td>" + State1 + "</td><td> " + (btn[1].ms / 1000.0) + " Seconds</td><td> <a class='btn btn-success btn-xs' href='/controlon?id=1?' role='button'>On</a> <a class='btn btn-danger btn-xs' href='/controloff?id=1' role='button'>Off</a></td></tr>\n");
  server->sendContent("           <tr class='text-uppercase'><td>Channel 3</td><td>" + State2 + "</td><td> " + (btn[2].ms / 1000.0) + " Seconds</td><td> <a class='btn btn-success btn-xs' href='/controlon?id=2?' role='button'>On</a> <a class='btn btn-danger btn-xs' href='/controloff?id=2' role='button'>Off</a></td></tr>\n"); 
  server->sendContent("            </tbody>\n");
