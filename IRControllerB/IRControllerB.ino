...
bool setupWifi(bool resetConf) {
  ...
  Serial.println("WiFi connected! User chose hostname '" + String(Supla_name) + String("' passcode '") + String(passcode) + "' and port '" + String(port_str) + "'");
...
void setup() {
  ...
  if (strlen(Supla_name) > 0) {
    WiFi.hostname(Supla_name);
  } else {
    WiFi.hostname().toCharArray(Supla_name, 20);
  }
...
//  server->sendContent("              <a href='http://" + String(Supla_name) + ".local" + ":" + String(web_port) + "'>Hostname <span class='badge'>" + String(Supla_name) + ".local" + ":" + String(web_port) + "</span></a></li>\n");
  server->sendContent("            <li class='active'>\n");
  server->sendContent("              <a href='http://" + WiFi.localIP().toString() + ":" + String(web_port) + "'>Local <span class='badge'>" + WiFi.localIP().toString() + ":" + String(web_port) + "</span></a></li>\n");
//  server->sendContent("            <li class='active'>\n");
//  server->sendContent("              <a href='http://" + externalIP() + ":" + String(web_port) + "'>External <span class='badge'>" + externalIP() + ":" + String(web_port) + "</span></a></li>\n");
  server->sendContent("            <li class='active'>\n");
...
void sendHomePage(String message, String header, int type, int httpcode) {
  ...
  if (last_recv.valid) {
    ...
    server->sendContent("              <form style='display:inline-block; margin:0; padding:0' action='/json' method='post'><input type='hidden' name='pass' value='" + String(passcode) + "'><tr class='text-uppercase'><td><code>" + String(last_recv.data) + "</code></td><td><code>" + String(last_recv.encoding) + "</code></td><td><code>" + String(last_recv.bits) + "</code></td><td><code>" + String(last_recv.address) + "</code></td><td><a class='btn btn-primary btn-xs' href='/store?id=1' role='button'>Store</a> <button name='plain' value='" + jsonTest + "' class='btn btn-primary btn-xs' type='submit'>TEST</button></td></tr></form>\n");
  }  
  if (last_recv_2.valid) {
    ...
    server->sendContent("              <form style='display:inline-block; margin:0; padding:0' action='/json' method='post'><input type='hidden' name='pass' value='" + String(passcode) + "'><tr class='text-uppercase'><td><code>" + String(last_recv_2.data) + "</code></td><td><code>" + String(last_recv_2.encoding) + "</code></td><td><code>" + String(last_recv_2.bits) + "</code></td><td><code>" + String(last_recv_2.address) + "</code></td><td><a class='btn btn-primary btn-xs' href='/store?id=2' role='button'>Store</a> <button name='plain' value='" + jsonTest + "' class='btn btn-primary btn-xs' type='submit'>TEST</button></td></tr></form>\n");
    }
    ...
    server->sendContent("              <form style='display:inline-block; margin:0; padding:0' action='/json' method='post'><input type='hidden' name='pass' value='" + String(passcode) + "'><tr class='text-uppercase'><td><code>" + String(last_recv_4.data) + "</code></td><td><code>" + String(last_recv_4.encoding) + "</code></td><td><code>" + String(last_recv_4.bits) + "</code></td><td><code>" + String(last_recv_4.address) + "</code></td><td><a class='btn btn-primary btn-xs' href='/store?id=4' role='button'>Store</a> <button name='plain' value='" + jsonTest + "' class='btn btn-primary btn-xs' type='submit'>TEST</button></td></tr></form>\n");
    }
    ...
    server->sendContent("              <form style='display:inline-block; margin:0; padding:0' action='/json' method='post'><input type='hidden' name='pass' value='" + String(passcode) + "'><tr class='text-uppercase'><td><code>" + String(last_recv_5.data) + "</code></td><td><code>" + String(last_recv_5.encoding) + "</code></td><td><code>" + String(last_recv_5.bits) + "</code></td><td><code>" + String(last_recv_5.address) + "</code></td><td><a class='btn btn-primary btn-xs' href='/store?id=5' role='button'>Store</a> <button name='plain' value='" + jsonTest + "' class='btn btn-primary btn-xs' type='submit'>TEST</button></td></tr></form>\n");
    }
