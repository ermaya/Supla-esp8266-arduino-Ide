...
bool state_rele_1 = false;
bool state_rele_2 = false;
bool state_rele_3 = false;
bool state_rele_4 = false;
...
void loop() {
  ...
  if (rele_milis < millis()){
   if (s == 17) {
    if (state_rele_1 == true){delay(20);Serial.write(relay_1_on, sizeof(relay_1_on));delay(20);}else{delay(20);Serial.write(relay_1_off, sizeof(relay_1_off));delay(20);}
    if (state_rele_2 == true){delay(20);Serial.write(relay_2_on, sizeof(relay_2_on));delay(20);}else{delay(20);Serial.write(relay_2_off, sizeof(relay_2_off));delay(20);}
    if (state_rele_3 == true){delay(20);Serial.write(relay_3_on, sizeof(relay_3_on));delay(20);}else{delay(20);Serial.write(relay_3_off, sizeof(relay_3_off));delay(20);}
    if (state_rele_4 == true){delay(20);Serial.write(relay_4_on, sizeof(relay_4_on));delay(20);}else{delay(20);Serial.write(relay_4_off, sizeof(relay_4_off));delay(20);}
    Serial.println("0,CONNECT");delay(20);
   }else{Serial.println("0,CLOSED");delay(20);
    delay(20);Serial.write(relay_1_off, sizeof(relay_1_off));delay(20);delay(20);Serial.write(relay_2_off, sizeof(relay_2_off));delay(20);delay(20);Serial.write(relay_3_off, sizeof(relay_3_off));delay(20);delay(20);Serial.write(relay_4_off, sizeof(relay_4_off));delay(20);
   } 
