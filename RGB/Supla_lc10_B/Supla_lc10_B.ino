...
Ticker ticker;
Supla::Control::RGBWLeds *rgbw = nullptr;
...
void AriluxRfHandler(void) {
  ...
  if (Arilux.rf_received_value && !((Arilux.rf_received_value == Arilux.rf_last_received_value) && (now - Arilux.rf_last_time < ARILUX_RF_TIME_AVOID_DUPLICATE))) {
    ...
    if (hostcode == stored_hostcode) {
      ...
      switch (keycode) {
        case 1:  // Power On
          rgbw->handleAction(0, Supla::TURN_ON);
          break;
        case 3:  // Power Off
          rgbw->handleAction(0, Supla::TURN_OFF);
          break;
        case 2:  // Toggle
          rgbw->handleAction(0, Supla::TOGGLE);
          break;
        case 4:  // Speed +
          rgbw->handleAction(0, Supla::BRIGHTEN_ALL);
          break;
        case 7:  // Speed -
          rgbw->handleAction(0, Supla::DIM_ALL);
          break;
        case 5:  // Scheme +
          rgbw->handleAction(0, Supla::BRIGHTEN_RGB);
          break;
        case 8:  // Scheme -
          rgbw->handleAction(0, Supla::DIM_RGB);
          break;
        case 6:  // Dimmer +
          rgbw->handleAction(0, Supla::BRIGHTEN_W);
          break;
        case 9:  // Dimmer -
          rgbw->handleAction(0, Supla::DIM_W);
          break;
        case 10:  // RED
          rgbw->setRGBW(255, 0, 0, 100, 0);
          break;
        case 11:  // GREEN
          rgbw->setRGBW(0, 255, 0, 100, 0);
          break;
        case 12:  // BLUE
          rgbw->setRGBW(0, 0, 255, 100, 0);
          break;
        case 13:  // ORANGE
          rgbw->setRGBW(255, 165, 0, 100, 0);
          break;
        case 14:  // LT GRN
          rgbw->setRGBW(144, 238, 144, 100, 0);
          break;
        case 15:  // LT BLUE
          rgbw->setRGBW(135, 206, 235, 100, 0);
          break;
        case 16:  // AMBER
          rgbw->setRGBW(255, 191, 0, 100, 0);
          break;
        case 17:  // CYAN
          rgbw->setRGBW(0, 255, 255, 100, 0);
          break;
        case 18:  // PURPLE
          rgbw->setRGBW(128, 0, 128, 100, 0);
          break;
        case 19:  // YELLOW
          rgbw->setRGBW(255, 255, 0, 100, 0);
          break;
        case 20:  // PINK
          rgbw->setRGBW(255, 105, 180, 100, 0);
          break;
        case 21:  // WHITE
          rgbw->setRGBW(255, 255, 255, 100, 0);
          break;
      }
    }
  }
...
void ondemandwifiCallback () {
  ...
  if (!wifiManager.startConfigPortal("SuplaLC10")) {
...
void setup() {
  ...
  rgbw = new Supla::Control::RGBWLeds(
