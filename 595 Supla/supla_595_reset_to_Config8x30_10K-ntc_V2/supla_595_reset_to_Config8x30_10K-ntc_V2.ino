...
ShiftRegister74HC595 sr (4, 15, 16, 0); 
#include <math.h>
...
// The extra parameters to be configured (can be either global or just in the setup)
  ...
  // set configportal timeout
    ...
    if (!wifiManager.startConfigPortal("Supla x30")) {
...
int supla_DigitalRead(int channelNumber, uint8_t pin) {
      ...
      if (channelNumber == 16){
        if (btn[16].mem ==0) return 0;      
        else return 1;
      }
      if (channelNumber == 17){
        if (btn[17].mem ==0) return 0;      
        else return 1;
      }
      if (channelNumber == 18){
        if (btn[18].mem ==0) return 0;      
        else return 1;
      }
      if (channelNumber == 19){
        if (btn[19].mem ==0) return 0;      
        else return 1;
      }
      if (channelNumber == 20){
        if (btn[20].mem ==0) return 0;      
        else return 1;
      }
      if (channelNumber == 21){
        if (btn[21].mem ==0) return 0;      
        else return 1;
      }
      if (channelNumber == 22){
        if (btn[22].mem ==0) return 0;      
        else return 1;
      }
      if (channelNumber == 23){
        if (btn[23].mem ==0) return 0;      
        else return 1;      
      }
      if (channelNumber == 24){
        if (btn[24].mem ==0) return 0;      
        else return 1;
      }
      if (channelNumber == 25){
        if (btn[25].mem ==0) return 0;      
        else return 1;
      }
      if (channelNumber == 26){
        if (btn[26].mem ==0) return 0;      
        else return 1;
      }
      if (channelNumber == 27){
        if (btn[27].mem ==0) return 0;      
        else return 1;
      }
      if (channelNumber == 28){
        if (btn[28].mem ==0) return 0;      
        else return 1;
      }
      if (channelNumber == 29){
        if (btn[29].mem ==0) return 0;      
        else return 1;
      }
...
void suplaDigitalWrite(int channelNumber, uint8_t pin, uint8_t val) {  //------------------------------------------------  Virtual ----------------------------
     ...
     if (channelNumber == 16){
       btn[16].mem =val;
       sr.set(16, val); // set single pin 
     }
     if (channelNumber == 17){
       btn[17].mem =val;
       sr.set(17, val); // set single pin 
     }
     if (channelNumber == 18){
       btn[18].mem =val;
       sr.set(18, val); // set single pin 
     }
     if (channelNumber == 19){
       btn[19].mem =val;
       sr.set(19, val); // set single pin 
     }
     if (channelNumber == 20){
       btn[20].mem =val;
       sr.set(20, val); // set single pin 
     }
     if (channelNumber == 21){
       btn[21].mem =val;
       sr.set(21, val); // set single pin 
     }
     if (channelNumber == 22){
       btn[22].mem =val;
       sr.set(22, val); // set single pin 
     }
     if (channelNumber == 23){
       btn[23].mem =val;
       sr.set(23, val); // set single pin 
     }
      if (channelNumber == 24){
       btn[24].mem =val;
       sr.set(24, val); // set single pin 
     }
     if (channelNumber == 25){
       btn[25].mem =val;
       sr.set(25, val); // set single pin 
     }
     if (channelNumber == 26){
       btn[26].mem =val;
       sr.set(26, val); // set single pin 
     }
     if (channelNumber == 27){
       btn[27].mem =val;
       sr.set(27, val); // set single pin 
     }
     if (channelNumber == 28){
       btn[28].mem =val;
       sr.set(28, val); // set single pin 
     }
     if (channelNumber == 29){
       btn[29].mem =val;
       sr.set(29, val); // set single pin 
     }
...
void setup() {  //------------------------------------------------ Setup ----------------------------------------------
  ...
  SuplaDevice.addRelay(117, false);  
  SuplaDevice.addRelay(118, false); 
  SuplaDevice.addRelay(119, false);   
  SuplaDevice.addRelay(120, false);  
  SuplaDevice.addRelay(121, false); 
  SuplaDevice.addRelay(122, false);   
  SuplaDevice.addRelay(123, false);
  SuplaDevice.addRelay(124, false);   
  SuplaDevice.addRelay(125, false);  
  SuplaDevice.addRelay(126, false); 
  SuplaDevice.addRelay(127, false);   
  SuplaDevice.addRelay(128, false);  
  SuplaDevice.addRelay(129, false); 
  SuplaDevice.addRelay(130, false);    
  // CHANNEL31 - Thermometer DS18B20
  ...
  btn[15].mem =0;
  btn[16].pin =22;          // pin gpio buton  0 = no buton
  btn[16].relay_pin =117;  // pin gpio Relay
  btn[16].channel =16;      // channel
  btn[16].ms =0;           //  if = 0 Bistable -- if > 0 Monostable for X ms
  btn[16].mem =0;
  btn[17].pin =22;         // pin gpio buton  0 = no buton 
  btn[17].relay_pin =118;  // pin gpio Relay
  btn[17].channel =17;      // channel
  btn[17].ms =0;           //  if = 0 Bistable -- if > 0 Monostable for X ms
  btn[17].mem =0;
  btn[18].pin =22;         // pin gpio buton  0 = no buton
  btn[18].relay_pin =119;  // pin gpio Relay
  btn[18].channel =18;      // channel
  btn[18].ms =0;           //  if = 0 Bistable -- if > 0 Monostable for X ms
  btn[18].mem =0;
  btn[19].pin =22;         // pin gpio buton  0 = no buton
  btn[19].relay_pin =120;  // pin gpio Relay
  btn[19].channel =19;      // channel
  btn[19].ms =0;           //  if = 0 Bistable -- if > 0 Monostable for X ms
  btn[19].mem =0;
  btn[20].pin =22;         // pin gpio buton  0 = no buton
  btn[20].relay_pin =121;    // pin gpio Relay
  btn[20].channel =20;      // channel
  btn[20].ms =0;           //  if = 0 Bistable -- if > 0 Monostable for X ms
  btn[20].mem =0;
  btn[21].pin =22;          // pin gpio buton  0 = no buton
  btn[21].relay_pin =122;  // pin gpio Relay
  btn[21].channel =21;      // channel
  btn[21].ms =0;           //  if = 0 Bistable -- if > 0 Monostable for X ms
  btn[21].mem =0;
  btn[22].pin =22;         // pin gpio buton  0 = no buton 
  btn[22].relay_pin =123;  // pin gpio Relay
  btn[22].channel =22;      // channel
  btn[22].ms =0;           //  if = 0 Bistable -- if > 0 Monostable for X ms
  btn[22].mem =0;
  btn[23].pin =22;         // pin gpio buton  0 = no buton
  btn[23].relay_pin =124;  // pin gpio Relay
  btn[23].channel =23;      // channel
  btn[23].ms =0;           //  if = 0 Bistable -- if > 0 Monostable for X ms
  btn[23].mem =0;
  btn[24].pin =22;         // pin gpio buton  0 = no buton
  btn[24].relay_pin =125;  // pin gpio Relay
  btn[24].channel =24;      // channel
  btn[24].ms =0;           //  if = 0 Bistable -- if > 0 Monostable for X ms
  btn[24].mem =0;
  btn[25].pin =22;         // pin gpio buton  0 = no buton
  btn[25].relay_pin =126;    // pin gpio Relay
  btn[25].channel =25;      // channel
  btn[25].ms =0;           //  if = 0 Bistable -- if > 0 Monostable for X ms
  btn[25].mem =0;
  btn[26].pin =22;          // pin gpio buton  0 = no buton
  btn[26].relay_pin =127;  // pin gpio Relay
  btn[26].channel =26;      // channel
  btn[26].ms =0;           //  if = 0 Bistable -- if > 0 Monostable for X ms
  btn[26].mem =0;
  btn[27].pin =22;          // pin gpio buton  0 = no buton
  btn[27].relay_pin =128;  // pin gpio Relay
  btn[27].channel =27;      // channel
  btn[27].ms =0;           //  if = 0 Bistable -- if > 0 Monostable for X ms
  btn[27].mem =0;
  btn[28].pin =22;         // pin gpio buton  0 = no buton 
  btn[28].relay_pin =129;  // pin gpio Relay
  btn[28].channel =28;      // channel
  btn[28].ms =0;           //  if = 0 Bistable -- if > 0 Monostable for X ms
  btn[28].mem =0;
  btn[29].pin =22;         // pin gpio buton  0 = no buton
  btn[29].relay_pin =130;  // pin gpio Relay
  btn[29].channel =29;      // channel
  btn[29].ms =0;           //  if = 0 Bistable -- if > 0 Monostable for X ms
  btn[29].mem =0;
  supla_btn_init();
  ...
  SuplaDevice.setName("Supla x 30");
